...
public class DegreeTest {
    ...
    public static void testHelper(String expectedFilename, String degreeFilename, String studentsFilename) {
        ...
        JSONObject actual = d.distribute("src/degree/data/" + degreeFilename, "src/degree/data/" + studentsFilename);
        JSONObject expected = parseJSON("src/degree/data/" + expectedFilename);
