...
insert into Employees values ('777-654-321','Yusif','Budianto',40.0,100000);
insert into Employees values ('123-987-654','Maria','Orlowska',40.0,110000);
insert into Employees values ('323-626-929','Tom','Robbins',35.0,50000);
insert into Employees values ('993-893-864','Susan','Ryan',60.0,200000);
insert into Employees values ('419-813-573','Max','Schmidt',40.0,120000);
insert into Employees values ('222-333-444','Pradeep','Sharma',30.0,40000);
insert into Employees values ('123-234-456','John','Smith',40.0,100000);
insert into Employees values ('632-647-973','Steven','Smooth',45.0,120000);
insert into Employees values ('747-400-123','Adam','Spencer',50.0,150000);
insert into Employees values ('326-888-711','Walter','Wong',50.0,180000);
